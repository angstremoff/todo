...
## Возможности
- Рабочие пространства (папки) для задач: создавайте, переименовывайте, удаляйте; задачи живут только внутри выбранного пространства. Меню действий открывается по кнопке «⋯» на таблетке пространства.
- Задачи — это просто текст (без заголовков и описаний).
- Вкладки: «Все», «Текущие», «Архив» (выполненные), статус переключается одной кнопкой.
- Задачи можно редактировать и удалять через меню «⋯» на карточке.
