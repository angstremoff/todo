...
## Возможности
- Рабочие пространства (папки) для задач: создавайте, переименовывайте, удаляйте; задачи живут только внутри выбранного пространства (долгое нажатие по названию откроет меню).
